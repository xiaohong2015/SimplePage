...
<body onLoad="MM_preloadImages('大田作物.jpg')">
...
<div class="gridContainer clearfix">
  <div id="LayoutDiv1">对其它流体网格布局 Div 标签使用“插入面板”。 注意: 所有布局 Div 标签必须直接插入到"gridContainer"div 标签中。 目前不支持嵌套布局 Div 标签。</div>
</div>
<span id="sprypassword1">
<input type="password" name="password1" id="password1">
<span class="passwordRequiredMsg">需要输入一个值。</span></span>
<form name="form1" method="post" action="">
  <span id="spryradio1">
    ...
    <label>
      ...
      单选</label>
    <br>
    <span class="radioRequiredMsg">请进行选择。</span></span>
</form>

<img src="" alt="111" name="Iron" width="32" height="32" style="background-color: #FF0033" onClick="MM_popupMsg('444')">
<a href="xh.com" onClick="MM_popupMsg('333')" onMouseOver="MM_swapImage('Image4','','大田作物.jpg',1)" onMouseOut="MM_swapImgRestore()" ><img id="Image4" src="字帖.jpg" alt="222"></a>
...
<object classid="flv2" data="1.flv" type="video/x-msvideo" archive="555" declare name="666" hspace="10" vspace="10" align="top" border="10" standby="777" dir="ltr" lang="zh">
  888
</object>
<div id="div1">
...
<a href="baidu.com" title="11" accesskey="3">baidu</a>
15/2/8  10:20 AM
<!--123 -->
<hr>
<iframe><frame>
